...
<%
	...
	String saveDirUpload = application.getRealPath("1_Project/upload");//이미지파일을 저장할 폴더 경로
	String saveDirDraws = application.getRealPath("1_Project/draws");//그린 이미지를 저장할 폴더 경로
